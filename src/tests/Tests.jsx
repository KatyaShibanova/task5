...
class Tests extends React.Component {
    constructor(props) {
        ...
        this.CounterCorrect = this.CounterCorrect.bind(this);
        ...
        return <div className="p-5">
            <div><p class="font-weight-bold">Q1</p>
                <div><p class="font-weight-normal">Text</p>
                    ...
                    <button ref="btn" type="button" id="2" class="btn btn-primary btn-lg btn-block" onClick={() => { this.CounterCorrect(); this.ButtonBlock()}}>Block level button</button>
